    ...
    * The hand finishes when there are no more unused letters or the user
    ...
    while num_letters != 0:
        ...
        # Otherwise (the input is not a single period):
            ...
            if isValidWord(word_input, hand, wordList) == False:

                # Reject invalid word (print a message followed by a blank line)
                print("Invalid word. Enter a valid word or '.' \n")
                print()
                continue
            # Otherwise (the word is valid):
                ...
                score = getWordScore(word_input, n)
                total_score += score
...
def playGame(wordList):
    ...
    """
    # We will use break statements to get out of loop


    stored_hand = {}
    while True:
        # Ask the user to enter their option
        option_input = input("Enter n to deal a new hand, r to replay the last hand, or e to end game: ")
